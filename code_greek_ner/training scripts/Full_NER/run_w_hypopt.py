...
import sys
sys.path.insert(1, 'path/to/glaux_nlp')
#for reproducibility:
set_seed(1234)
import os
...
train_path = '../final_dataset/normal/train.conll'

test_path = '../final_dataset/normal/test.conll'

val_path = '../final_dataset/normal/val.conll'
...
clrf = Classifier(args.transformer_path,base_output_dir + args.name,
                  ...
                  eval_data=val_path,
                  test_data=test_path,
                  ignore_label=None, data_preset='simple', add_prefix_space=True, monitor_metric='seqeval_ner')
